  ...
  return (
    <section className="py-24 bg-secondary">
      <div className="container mx-auto px-6">
        ...
        >
          <h2 className="text-4xl font-serif font-bold text-foreground mb-4">{t('faq.heading')}</h2>
          <p className="text-muted-foreground font-sans text-lg">{t('faq.subheading')}</p>
        </motion.div>
