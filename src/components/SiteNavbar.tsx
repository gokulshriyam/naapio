...
import { Menu, X, User, LogOut, ShoppingBag, Settings, Scissors } from "lucide-react";
              ...
              <div className="space-y-3">
                ...
                <Button variant="gold" className="w-full" onClick={() => {
                  if (/^\d{4}$/.test(loginOtp)) {
                    const userData = { phone: loginPhone, name: 'Customer', loggedInAt: new Date().toISOString() };
