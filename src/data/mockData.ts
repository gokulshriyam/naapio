...
export const faqItems = [
  ...
  },
  {
    ...
    a: "Absolutely. All payments are held in escrow and released to the artisan only when you approve the final milestone. If you're not satisfied, our dispute resolution team steps in.",
  },
  {
